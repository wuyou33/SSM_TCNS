...
\mypara Define the set $\mathbf{T}=\{Z_1,\ldots,Z_N:Z_W=\mathbin{\mathtt{diag}}(Z_1,\ldots,Z_N)\succeq0,p_{MI}=\bar{v}^\top Z_W\bar{v}\in\mathbb{R}[x,v]\}$. For a set $\mathbf{G}$ define the indicator (also known as barrier) function $H:\{\mathbf{G}\}\times \mathbb{R}^k\to \{0\}\cup\{\infty\}$ as
\begin{equation*}
...
\begin{equation*}
	\begin{array}{rl}
		\text{minimize}&\displaystyle H(\mathbf{T},(Z_1,\ldots,Z_N))+\sum_{i=1}^N H(\mathbf{S}_{\succ0}^{\alpha_i},Q_{W_i})\\
...
\begin{enumerate}
	...
	\begin{equation*}
	\begin{array}{rcl}
		Q_{W_i}^{k+1}&=&\mathbin{\mathtt{argmin}}_{Q_{W_i}\in\mathbf{S}_{\succ0}^{\alpha_i}}\left|\left|Q_{W_i}-Z_i^k+\Lambda_i^k\right|\right|_F^2\;,
	\end{array}
\end{equation*}
