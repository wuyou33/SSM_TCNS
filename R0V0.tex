...
\mypara Note that the ADMM cannot be employed to compute $W$ using the MI~\eqref{eq:Artstein-Sontag:inequality:dual}, in this case. This follows from the fact that $\ker(B)\equiv0$.
