...
\begin{theorem}\label{thm:main result}
	If there exists a sum-separable control-contraction metric for system \eqref{eq:general system}, then there exists a solution to Problem~\ref{problem formulation}. In particular, given a graph $\mathscr{G}_c$ describing the communication network among different controllers
\end{theorem}
