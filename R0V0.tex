...
\mypara The existence a contraction metric for system \eqref{eq:general system} implies that every two solutions to this system converge to each other exponentially. The proof of this claim, for the case in which $u\equiv0$ and $\delta_u\equiv0$, can be found in \cite[Theorem 1]{Lewis1951}, and \cite[Theorems 5.7 and 5.33]{Reich2005}, and \cite[Lemma 3.3]{Isac2008}.
...
\mypara Consequently, whenever the following matrix inequality holds 
	...
	\end{equation}
	uniformly over $(x,u)\in\mathbb{R}^n\times\mathbb{R}^m$, the matrix $T$ is uniformly negative definite. Thus, the MI~\eqref{eq:MI formulation} holds. This concludes the proof.
\end{proof}
...
\end{equation}
\end{subequations}
Note that, the requirement of $A$ to be diagonally dominant can be interpreted as the network having stable agents interconnected with a weak coupling.
