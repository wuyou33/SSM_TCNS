...
\mypara In all cases, the computed matrix $W$ has a block-diagonal structure as follows
\begin{equation*}
...
\begin{equation*}
	...
	\end{array}
\end{equation*}
Solving the MI \eqref{eq:MI formulation} the following components the matrices $W$ and $Y$ were obtained
\begin{align*}
 W=&\mathbin{\mathtt{diag}}\left(W_a,W_b,W_b,W_a\right),\\
 Y=&\begin{bmatrix}
 	Y_{11}&Y_{12}&0&0&0&0&0&0\\
 	0&0&Y_{23}&Y_{24}&0&0&0&0\\
 	0&0&0&0&Y_{35}&Y_{36}&0&0\\
 	0&0&0&0&0&0&Y_{47}&Y_{48}
 \end{bmatrix}
\end{align*}
where
\begin{equation*}
...
and
\begin{align*}
 Y_{11}(q_i)=Y_{47}(q_i)=&\ -3.1y_i+0.06x_iy_i\;,\\
 Y_{12}(q_i)=Y_{48}(q_i)=&\ -3.6-0.02x_i-2.3y_i^2-2.4x_i^2\;,\\
 Y_{23}(q_i)=Y_{35}(q_i)=&\ -3.1y_i\;,\\
 Y_{24}(q_i)=Y_{26}(q_i)=&\ -3.8-2.1y_i^2-2.2x_i^2\;.
\end{align*}
