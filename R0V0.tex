...
\begin{enumerate}
	...
	\begin{equation*}
	\begin{array}{rcl}
		W_i^{k+1}&=&\mathbin{\mathtt{argmin}}_{W_i\in\mathbf{S}_{\succ0}^{n_i}}\left|\left|W_i^k-Z_i^k+\Lambda_i^k\right|\right|_F^2\;,
	\end{array}
\end{equation*}
	...
	\begin{equation*}
		Z^{k+1}=\mathbin{\mathtt{argmin}}_{Z\in\mathbf{T}}\sum_{i=1}^N\left|\left|W_i^{k+1}-Z_i^k+\Lambda_i^k\right|\right|_F^2\;;
	\end{equation*}
