...
\begin{align*}
	\Xi=\{k^\ast:\mathbb{R}_{\geq0}\times\mathbb{R}^n\to\mathbb{R}^m:\forall i\in\mathbb{N}_{[1,m]},k_i^\ast\ \text{depends on}\\
	 \text{the components of}\ x\ \text{with indexes given by}\ \mathscr{K}(i)\}.
\end{align*}
