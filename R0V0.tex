...
In the last case, the fully decentralized scenario has been considered. The time taken by the parser to solve the MI~\eqref{eq:MI formulation} was 2.6 seconds. In this case, $\mathscr{K}(i)=\{i\}$, 
\begin{equation*}
	\begin{array}{rl}
		\mathbf{C}_1=\mathbf{C}_2=\{e_1\},&\mathbf{C}_3=\mathbf{C}_4=\{e_2\},\\
		\mathbf{C}_5=\mathbf{C}_6=\{e_3\},&\mathbf{C}_7=\mathbf{C}_8=\{e_4\}
	\end{array}
\end{equation*}
