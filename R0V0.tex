...
\mypara The graph describing the network structure in provided in Figure~\ref{fig:cycle graph}.
\begin{figure}[htpb!]
	\centering
...
\mypara The graph describing the network structure in provided in Figure~\ref{fig:graph}.
\begin{figure}[htpb!]
	\centering
