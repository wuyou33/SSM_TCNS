...
\mypara The matrix $W$ obtained is given by $\mathbin{\mathtt{diag}}(\overline{W},\overline{W},\overline{W},\overline{W})$, where $\overline{W}=\mathbin{\mathtt{diag}}(0.72,0.19)$. The matrix $Y$ is given by
\begin{equation*}
	Y(q)=\begin{bmatrix}
